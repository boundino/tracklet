...
# 			    fileNames = cms.untracked.vstring('/store/hidata/HIRun2022A/HITestRaw0/RAW/v1/000/362/294/00000/03ff59ee-4b5f-4726-8f12-b1bacec1667d.root')
# )
...
process.pixel = cms.EDAnalyzer('PixelPlant',
			       pixel_tag = cms.InputTag("siPixelRecHitsPreSplitting"),
                               ...
                               hlt_paths = cms.vstring('HLT_ZeroBias_HighRate_v5'),

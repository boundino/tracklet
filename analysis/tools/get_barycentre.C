...
// float dxshift[] = {0, 0.0723367}, dyshift[] = {0, -0.167845}, dzshift[] = {0, -0.36}; // BS_MC = BS_data - dshift (barycentre)
float dxshift[] = {0, 0.069865}, dyshift[] = {0, -0.176698}, dzshift[] = {0, -0.365973}; // BS_MC = BS_data - dshift (barycentre)
...
// "/eos/cms/store/group/phys_heavyions/wangj/tracklet2025/private/AMPT_NoPU_100kEvents_OO_5360GeV_GenSim_032525.root#AMPT,/eos/cms/store/group/phys_heavyions/wangj/tracklet2025/private/Hijing_NoPU_100kEvents_OO_5360GeV_GenSim_030825.root#HIJING"
int macro(std::string input="",
  ...
  xjjroot::setgstyle(1);
  xjjroot::mypdf* pdf = new xjjroot::mypdf(Form("../figspdf/vertex/pixel-barycentre-%s.pdf", tag.c_str()), "c", 600, 600);
